...
export type ProjectStatus = 'recruiting' | 'in-progress' | 'paused' | 'completed';
export type ProjectType = 'tech' | 'social' | 'culture' | 'finance' | 'education' | 'health' | 'environment' | 'other';
