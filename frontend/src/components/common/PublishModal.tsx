...
import { X, Lightbulb, Wrench, Bot, ArrowLeft, Briefcase } from 'lucide-react';
...
type ContentType = 'idea' | 'skill' | 'request' | 'project' | null;

const contentTypes = [
  { type: 'project' as ContentType, label: '发布创业项目', icon: Briefcase, description: '发布你的创业项目，寻找合作伙伴和投资机会。' },
