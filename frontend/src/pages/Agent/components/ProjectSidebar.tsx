...
const ProjectSidebar: React.FC<ProjectSidebarProps> = ({
    ...
    return (
      <div className="mb-4">
        <button
          ...
          className="w-full flex items-center justify-between p-2 text-xs text-gray-600 uppercase tracking-wide hover:text-gray-800"
        >
              ...
              >
                ...
                <div className="ml-6 mt-1">
                  <div className="flex items-center text-xs">
                    ...
                    <span className="ml-2 text-gray-500">{project.progress}%</span>
                  </div>
                </div>
              </div>
            ))}
  ...
  return (
    <div className={`bg-white text-gray-900 h-full flex flex-col border-r border-gray-200 ${
      collapsed ? 'min-w-12' : 'min-w-48'
    }`}>
      {/* 头部 */}
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          {!collapsed && (
            <h2 className="font-semibold text-gray-800">项目管理器</h2>
          )}
          <button 
      ...
      {!collapsed && (
        <div className="p-4 flex-1 overflow-y-auto h-0">
          {/* 新建项目按钮 */}
          <div className="mb-6">
