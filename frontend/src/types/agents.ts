...
export const AVAILABLE_AGENTS: AgentInfo[] = [
    ...
    },
    {
        ...
        category: AGENT_CATEGORIES.find(c => c.id === 'market_analysis')!,
    ...
    },
    {
        ...
        category: AGENT_CATEGORIES.find(c => c.id === 'tech_development')!,
    ...
    },
    {
        ...
        category: AGENT_CATEGORIES.find(c => c.id === 'finance_analysis')!,
